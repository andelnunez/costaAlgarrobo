...
urlpatterns = patterns('',
    ...
    url(r'^equipamiento/$', 'manager.views.equipamento'),
    ...
    url(r'^foto/(?P<id_galeria>.*)$', 'manager.views.foto'),
    url(r'^video/(?P<id_video>.*)$', 'manager.views.video'),
    ...
    url(r'^mar/$', 'manager.views.cotizacion'),
    url(r'^bosque/$', 'manager.views.cotizacion'),
)
