# Django settings for CostaAlgarrobo project.
#encoding:utf-8
...
SECRET_KEY = 'lm-e(=h!^5!bast&4kvj_zg3g#hq&yc$k8*61^vi_hz&$tsg9*'
...
ROOT_URLCONF = 'CostaAlgarrobo.urls'

# Python dotted path to the WSGI application used by Django's runserver.
WSGI_APPLICATION = 'CostaAlgarrobo.wsgi.application'
